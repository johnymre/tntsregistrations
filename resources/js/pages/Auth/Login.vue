    ...
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2">
      ...
      <div class="hidden md:flex relative bg-blue-600 items-center justify-center overflow-hidden px-10 py-12">
        ...
        <div class="relative w-full max-w-sm">
          ...
          <div class="absolute -left-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white shadow-lg flex items-center justify-center">
          ...
          <div class="absolute -left-2 bottom-2 w-11 h-11 rounded-full bg-white shadow-lg flex items-center justify-center">
