...
function openManageStudents(section: Section): void {
    ...
    assignedList.value = props.students.filter(
        (s: Student) => s.section === section.name,
    );
...
const filteredSections = computed(() => {
    return props.sections.filter((s: Section) => {
        return (
            gradeFilter.value === 'All' || s.grade_level === gradeFilter.value
        );
    });
});
            ...
            >
                ...
                <div class="flex flex-1 flex-col p-5">
                    ...
                    <div class="mb-4">
                        ...
                        >
                            ...
                            <span class="font-semibold text-gray-900"
                                >{{ s.enrolled_count }}/{{ s.capacity }}</span
                            >
                        </div>
                        <div
                        ...
                        >
                            <div
                                ...
                                :class="
                                    isFull(s) ? 'bg-gray-900' : 'bg-blue-500'
                                "
                                :style="{
                                    width:
                                        Math.min(
                    ...
                    <div class="mt-auto flex items-center gap-2">
                        <button
                            class="flex-1 rounded-xl border border-blue-200 py-2 text-sm font-semibold text-blue-600 transition hover:bg-blue-50"
                        >
                            Edit Adviser
                        </button>
                        <button
                            @click="openManageStudents(s)"
                            class="flex-1 rounded-xl bg-blue-600 py-2 text-sm font-semibold text-white transition hover:bg-blue-700"
                        >
                            Manage Students
                        </button>
                    </div>
                ...
                >
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-gray-500">
                            {{ activeSection?.grade_level }} | Capacity:
                            {{ assignedList.length }}/{{
