...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/register', [AuthController::class, 'createAccount'])->name('register');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/students', [RegistrationController::class, 'index'])->name('students');
    ...
    Route::post('/sectioning/{section}/students', [SectionController::class, 'updateStudents'])->name('sectioning.students.update');
